...
class Tracker:
    ...
    def processUnmatchedTracks(self, unmatchedTracksIndexes, tracks, lostTracks, removedTracks):
        for trackIndex in unmatchedTracksIndexes:
            ...
            if(track.getTrackState() == TrackState.LOST):
                ...
                self.moveElement(trackIndex, tracks, removedTracks)
    ...
    def simpleTracking(self, tracks, detections):
        ...
        self.processUnmatchedTracks(unmatchedTracksIndexes, self._newTracks, lostTracksBuffer, self._removedTracks)
    ...
    def tracking(self, detections):
       ...
       # Stage 1: Match detections1 (High Scoring Detection) with matchable tracks (MATCHED/LOST Tracks)
        ...
        self.processUnmatchedTracks(unmatchedTracks2Indexes, unmatchedTracks1, lostTracksBuffer, self._removedTracks)
        self.processUnmatchedTracks(unmatchedTracks3Indexes, self._newTracks, lostTracksBuffer, self._removedTracks)
